        ...
        <section id="specialist-list">
            <div class="specialist-block">
                <div class="specialist-info">
                    <img src="./assets/images/selfie2.png" alt="Photo de Dr. jahsauveyimele">
                    <div class="details">
                        <h3>Dr. jahsauveyimele</h3>
            ...
            <div class="specialist-block">
                <div class="specialist-info">
                    <img src="./assets/images/profil.jpg" alt="Photo de Dr. Joel Foko">
                    <div class="details">
                        <h3>Dr. Joel Foko</h3>
                        <p class="specialty">Neurologue</p>
                    </div>
                </div>
                <div class="planning-info">
                    <p><strong>Planning :</strong>Mardi, Jeudi</p>
                    <p><strong>Crénaux :</strong>10:00, 15:00</p>
                </div>
                <div class="rdv-action">

                    <!-- <button class="btn btn-rdv" data-id="2">P<a href="./Prendre RDV.php">Prendre un rendez-</a></button> -->
                    <button class="btn btn-danger btn-md" data-bs-toggle="modal" data-bs-target="#formModal"
                        onclick="createForm()">
                        <!-- <i class="fas fa-plus me-1"></i>  -->
                        Prendre un rendez-vous
            ...
            <div class="specialist-block">
                <div class="specialist-info">
                    <img src="./assets/images/consult.jpg" alt="Photo de Dr. Marc Santa">
                    <div class="details">
                        <h3>Dr. Marc Santa</h3>
                        <p class="specialty">Phytothérapeute</p>
                    </div>
                </div>
                <div class="planning-info">
                    <p><strong>Planning :</strong>Tous les jours</p>
                    <p><strong>Crénaux :</strong>09:30, 11:30, 16:00</p>
                </div>
                <div class="rdv-action">

                    <!-- <button class="btn btn-rdv" data-id="3"><a href="./Prendre RDV.php">Prendre un rendez-vous</a></button> -->
                    <button class="btn btn-danger btn-md" data-bs-toggle="modal" data-bs-target="#formModal"
                        onclick="createForm()">
                        <!-- <i class="fas fa-plus me-1"></i>  -->
                        Prendre un rendez-vous
            ...
            <div class="specialist-block">
                <div class="specialist-info">
                    <img src="./assets/images/satoro.jpg" alt="Photo de Dr. Marc Santa">
                    <div class="details">
                        <h3>Dr. Marc Santa</h3>vous
                        <p class="specialty">Phytothérapeute</p>
                    </div>
                </div>
                <div class="planning-info">
                ...
                <div class="rdv-action">
                    ...
                    <!-- <button class="btn btn-rdv" data-id="4"><a href="./Prendre RDV.php">Prendre un rendez-vous</a></button> -->
                    <button class="btn btn-danger btn-md" data-bs-toggle="modal" data-bs-target="#formModal"
                        onclick="createForm()">
                        <!-- <i class="fas fa-plus me-1"></i>  -->
                        Prendre un rendez-vous
