...
if ($route['controller'] !== null && file_exists($route['controller'])) {
...
<head>
    ...
    <meta name="description" content="ECO-SANTE Télémédecine" />
    <title>ECO-SANTE Dashboard</title>
    <!-- Favicon icon -->
...
<body>
    ...
    <div id="main-wrapper">
        ...
        <div class="nav-header">
            <!-- <a href="index.html" class="brand-logo">
               ...
               <div class="logo">
                ...
                <span style="color:blue;font-weight:900;font-size:30px;">ECO-SANTE</span>
        </div>
                        ...
                        <ul class="navbar-nav header-right main-notification">
                            ...
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="#" role="button" data-toggle="dropdown">
                                    <?php 
                                        if($profil->photo != null && $profil->photo != '') {
                                            echo '<img src="'. RES_USER_PHOTO['path'] . $profil->photo .'" width="20" alt="">';
                                        }
                                        else {
                                            echo '<img src="'. RES_USER_PHOTO['path'] . 'user.png' .'" width="20" alt="">';
                                        }
                                    ?>
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <a href="index.php?view=logout" class="dropdown-item ai-icon">
            ...
            <div class="deznav-scroll">
                <div class="main-profile">
                    <div class="image-bx">
                        <?php 
                            if($profil->photo != null && $profil->photo != '') {
                                echo '<img src="'. RES_USER_PHOTO['path'] . $profil->photo .'" alt="">';
                            }
                            else {
                                echo '<img src="'. RES_USER_PHOTO['path'] . 'user.png' .'" alt="">';
                            }
                        ?>
                ...
                <ul class="metismenu" id="menu">
                    ...
                    <li>
                        <a class="ai-icon" href="index.php?view=dashboard">
                    ...
                    <li class="nav-label">Suivie des patients</li>
                    <li>
                        ...
                        <ul aria-expanded="false">
                            <li>
                                <a href="index.php?view=rdv.edit">
                                    Ajouter un Rendez-vous
                                </a>
                            </li>
                            <li>
                                <a href="index.php?view=rdv">
                    ...
                    <li>
                        ...
                        <ul aria-expanded="false">
                            <li>
                                <a href="index.php?view=consultation.edit">
                                    Ajouter une consultation
                                </a>
                            </li>
                            <li>
                                <a href="index.php?view=consultation">
                    ...
                    <li>
                        ...
                        <ul aria-expanded="false">
                            <li>
                                <a href="index.php?view=user.edit">
                    ...
                    <li>
                        <a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                            ...
                            <span class="nav-text">Mode de paiement</span>
                        </a>
                        <ul aria-expanded="false">
                            <li>
                                <a href="index.php?view=mode.edit">
                                    Ajouter un Mode de paiement
                                </a>
                            </li>
                            <li>
                                <a href="index.php?view=mode">
                    ...
                    <li>
                        ...
                        <ul aria-expanded="false">
                            <li>
                                <a href="index.php?view=specialite.edit">
                                    Ajouter une Spécialité
                                </a>
                            </li>
                            <li>
                                <a href="index.php?view=specialite">
                ...
                <div class="copyright">
                    <p><strong>ECO-SANTE</strong> © 2025 All Rights Reserved</p>
                    <p class="fs-12">Made with <span class="heart"></span> by MT</p>
                </div>
            </div>
        </div>
        <!--**********************************
        ...
        ***********************************-->
        <div class="content-body">
            ...
            <?php 
                if ($route['view'] !== null && file_exists($route['view'])) {
        ...
        ***********************************-->
        <div class="footer">
            <div class="copyright">
                <p>Copyright © Designed &amp; Developed by <a href="#" target="_blank">MT</a> 2025</p>
            </div>
        </div>
        <!--**********************************
            Footer end
    ...
    ***********************************-->
    ...
    <!-- <script src="./assets/vendor/peity/jquery.peity.min.js"></script> -->ECO-SANTE
